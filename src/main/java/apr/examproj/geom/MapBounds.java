...
//
// public MapBounds(double minLatitude, double maxLatitude, double minLongitude,
// double maxLongitude) {
...
// return new Point2D((latitude - minLatitude) / width, (longitude -
// minLongitude) / height);
// }
//
// public Point2D normalize(Point2D point) {
// return new Point2D((point.x - minLatitude) / width, (point.y - minLongitude)
// / height);
// }
//
// public boolean isInBounds(Point2D point) {
// return point.x >= minLatitude && point.x <= maxLatitude && point.y >=
// minLongitude && point.y <= maxLongitude;
// }
//
// public boolean isInBounds(double latitude, double longitude) {
// return latitude >= minLatitude && latitude <= maxLatitude && longitude >=
// minLongitude
...
// getClass().getSimpleName(), minLatitude, minLongitude, maxLatitude,
// maxLongitude);
// }
//
// }
