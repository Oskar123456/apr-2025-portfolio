...
// //
// // public StreetMapOld(MapData mapData) {
...
// // tags.get("building").equals("detached")) {
...
// // System.out.println(
// // "StreetMap.guify() : " + parentPane + " " + parentPane.getWidth() + " " +
// // parentPane.getHeight());
// //
// // layout = GUIFactory.defaultChildVBox(parentPane,
// // "street-map__street-map-layout");
// //
// // title = new HBox();
...
// // return String.format("%s[bounds: %s, nodes: %d, streets: %d, buildings:
// %d]",
// // getClass().getSimpleName(), bounds.toString(), nodes.size(),
// streets.size(),
// // buildings.size());
// // }
//
